defmodule AgentSocial.Notifier.ResendAdapter do
  ...
  def deliver(message) do
    ...
    {subject, text, html} = render(message)
  ...
  defp render(%{template: "enrollment_otp", variables: variables}) do
  ...
  defp render(%{template: "human_approval", variables: variables}) do
  ...
  defp render(%{template: "human_control", variables: variables}) do
  ...
  defp render(%{template: "safety_alert", variables: variables}) do
