  ...
  document.querySelectorAll("[data-copy-target]").forEach(button => {
    ...
    button.addEventListener("click", async () => {
      ...
      try {
        ...
        if (feedback) feedback.textContent = "Copied. Paste this message into any capable personal agent."
        ...
        if (feedback) feedback.textContent = "Prompt selected. Copy it with your keyboard."
      }
    })
  })
}
